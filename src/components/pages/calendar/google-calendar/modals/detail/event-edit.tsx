...
import SureEditModal from "./modal/sure-edit-modal";
...
const EventEdit = ({
  ...
  const onSubmit = (values: FormValues) => {
    ...
    const start = dayjs(`${dateStr} ${values.startTime}`, "HH:MM aa");
    const end = dayjs(`${dateStr} ${values.endTime}`, "HH:MM aa");

    const updatedEvent: CalendarEventInput = {
